...
const formattedTime = (date) => {
  const parsedDate = parseISO(date); // Chuyển đổi chuỗi thành đối tượng ngày tháng
  return formatDistanceToNow(parsedDate, { addSuffix: true }); // Tính thời gian so với hiện tại
};
</script>
